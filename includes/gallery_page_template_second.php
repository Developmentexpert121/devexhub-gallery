...
<div class="row outer_dh_gallery_plugin">
	<div class="col-md-12 all-items dh_all_cat_list">
		<ul class="pt-2 nav flex-md-row flex-column shadow bg-blue-custom nav-pills pills-dark my-5 tab-outer flex-nowrap d-flex justify-content-start rounded" id="pills-tab" role="tablist">
		    <li class="nav-item mx-2 mr-0 text-center mb-3">
	...
	<div class="col-md-12 sticky-top dh_cat_imgs mb-5">
